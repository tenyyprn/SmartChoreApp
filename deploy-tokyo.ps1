# Smart Chore App - Source-based Cloud Run Deployment - Tokyo Region (Windows PowerShell)
# This script deploys directly from source code without Docker to Tokyo
...
Write-Host "Region: $REGION (🇯🇵 Tokyo, Japan)" -ForegroundColor Cyan
...
# Deploy from source code directly to Tokyo region
Write-Host "🚀 Deploying from source code to Tokyo..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "✅ Tokyo deployment completed!" -ForegroundColor Green
Write-Host "🌐 Smart Chore App URL: $SERVICE_URL" -ForegroundColor Green
Write-Host "🇯🇵 Deployed in Tokyo (asia-northeast1)" -ForegroundColor Green
